    ...
    return (
        <section id='about-section' className="about-section">
            ...
            <div className="am-container">
                ...
                <p>I am a self-taught web developer currently based in Boston. With a Bachelors Degree in Engineering, I continue to use my STEM background and analytical skills in my web development work. My focus is on creating clean modern websites and web applications that solve real-world problems.</p>
